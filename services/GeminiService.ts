...
// Initialize with a named apiKey parameter as per guidelines
const ai = new GoogleGenAI({ apiKey: process.env.API_KEY });
// High-quality model for coding and reasoning tasks
...
- \`suggestion\`: A string containing the suggestion phrase (e.g., "Add a pulsing color effect", "Control the pattern complexity").
